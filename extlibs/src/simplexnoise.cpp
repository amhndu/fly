...
float octave_noise_2d( const float octaves, const float persistence, const float scale, const float lacunarity,
...
float scaled_octave_noise_2d( const float octaves, const float persistence, const float scale,
                              const float lacunarity, const float loBound, const float hiBound, const float x, const float y )
{
    return octave_noise_2d(octaves, persistence, scale, lacunarity, x, y) * (hiBound - loBound) / 2 + (hiBound + loBound) / 2;
}
...
//
// Returned value will be between loBound and hiBound.
float scaled_octave_noise_3d( const float octaves, const float persistence, const float scale, const float lacunarity,
                              const float loBound, const float hiBound, const float x, const float y, const float z )
{
    return octave_noise_3d(octaves, persistence, scale, lacunarity, x, y, z) * (hiBound - loBound) / 2 + (hiBound + loBound) / 2;
}
